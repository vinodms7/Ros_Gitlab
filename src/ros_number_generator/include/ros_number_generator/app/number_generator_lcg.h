...
class NumberGeneratorLCG : public NumberGenerator {
  ...
  *
  **/
  NumberGeneratorLCG(uint32_t max_random_value = 1000, uint32_t min_random_value = 0);
 ...
 protected:
   ...
   * @param[in]	  None
   *
   * @return		  uint32_t Generates and returns the number generated by the implementation
   **/
